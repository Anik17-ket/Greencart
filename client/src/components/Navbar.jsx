                    ...
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2 w-32 rounded-md text-sm z-40'>
                            <li
                                ...
                                className='p-1.5 pl-3 hover:bg-green-100 hover:text-green-700 cursor-pointer transition'
                            >
                                My Orders
                            </li>
                            <li
            ...
            {  open && (
                ...
                <button onClick={()=>{setOpen(false);
                 ...
                 className="cursor-pointer px-6 py-2 mt-2 bg-green-600 hover:bg-green-700 transition text-white rounded-full text-sm">
                    ...
                    <button onClick={logout} className="cursor-pointer px-6 py-2 mt-2 bg-green-600 hover:bg-green-700 transition text-white rounded-full text-sm">
                    Logout
                </button>
                 )}
            </div>
