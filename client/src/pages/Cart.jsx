...
const Cart = () => {
    ...
    const {products,currency,cartItems,removeFromCart,getCartCount,updateCartItem,navigate,totalAmount,getCartAmount} =useAppContext();
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select onChange={e => updateCartItem(product._id,Number(e.target.value))} value={cartItems[products._id]} className='outline-none'>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500"> { selectedAddress ? `${selectedAddress.street}, ${setSelectedAddress.city},${selectedAddress.state},${setSelectedAddress.country}`: "No address found"}</p>
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-green-600 text-white font-medium hover:bg-green-600 transition">
